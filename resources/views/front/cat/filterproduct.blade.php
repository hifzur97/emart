                ...
                <div class="product-info text-left">
                    ...
                    @if(get_product_rating($product->id) != 0)
                        <div class="pull-left star-right">
                            <div class="star-ratings-sprite"><span style="width:{{ get_product_rating($product->id) }}%" class="star-ratings-sprite-rating"></span>
                            </div>
                            </div>
                    @else
                            ...
                            @if(Auth::user()->wishlist()->count() < 1) 
                                ...
                                <li class="lnk wishlist active">
                                    <a mainid="{{ $sub->id }}" title="{{ __('staticwords.RemoveFromWishlist') }}"
                                        ...
                                        data-remove="{{url('removeWishList/'.$sub->id)}}"> <i class="icon fa fa-heart"></i>
                                    </a>
                                </li>
                                @else
                    ...
                    <div class="action">
                        <ul class="list-unstyled">
                            ...
                            @if(Auth::user()->wishlist()->count() < 1) 
                                ...
                                @if(!empty($ifinwishlist))
                                <li class="lnk wishlist active">
                                    <a mainid="{{ $sub->id }}" title="{{ __('staticwords.RemoveFromWishlist') }}" class="add-to-cart removeFrmWish active cursor-pointer color000"
                                        data-remove="{{url('removeWishList/'.$sub->id)}}"> <i class="icon fa fa-heart"></i>
                                    </a>
                                </li>
                                @else
