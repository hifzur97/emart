...
<nav class="navbar navbar-dark display-none navbarBlue stickCartNav fixed-top">
  <div class="container-fluid">
    ...
    <div id="navbarSupportedContent">
      <form action="{{ $product->type == 'ex_product' ? $product->external_product_link : route('add.cart.simple',['pro_id' => $product->id, 'price' => $product->price, 'offerprice' => $product->offer_price]) }}" method="{{$product->type == 'ex_product' ? 'GET' : 'POST'}}">
                      ...
                      <div class="pull-left">
                        <div class="stock-box">
                          <span class="label">{{ __('staticwords.Availability') }} : <span
                              class="{{ $product->stock == 0 ? "text-danger" : "text-green"}}">{{ $product->stock == 0 ? __("Out of Stock") : __("In Stock") }}</span>
                          </span>
                        </div>
                      </div>
                      <div class="pull-left">
