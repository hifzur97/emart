                ...
                <div class="box-body">
                    <form action="{{ route("ship.item",$invoice->id) }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input required placeholder="{{ now()->addDays(7)->format('d-M-Y') }}" name="exp_delivery_date" type="text" class="deliverydate form-control" value="{{ $invoice->exp_delivery_date ? date("Y-m-d",strtotime($invoice->exp_delivery_date)) : '' }}"/>
