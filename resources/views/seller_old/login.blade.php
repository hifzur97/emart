...
<body>
	...
	<div class="authenticate-bg limiter">
        ...
        @endif
				<form action="{{ route('seller.login.do') }}" method="post" class="login100-form validate-form">
          @csrf
              ...
              <table class="mt-3 table table-bordered">
                <tbody>
                  <tr>
                    ...
                    <td>{{ __("Email") }}</td>
                    <td>{{ __("seller01@mediacity.co.in") }}</td>
    ...
    <script>
      ...
      $(function(){
        $(".copycred").on("click",function(){
          ...
          $("input[name=email]").val('seller01@mediacity.co.in');
          ...
          $('.login100-form-btn').text('{{ __("Logging in") }}');
