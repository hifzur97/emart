      ...
      <tbody id="sortable">
        ...
        <tr class="row1" data-id="{{ $cat->id }}">
          ...
          <td>
            ...
            <img src=" {{url('images/subcategory/'.$cat->image)}}" width="100px" height="100px"
              title="{{ $cat->title }}">
            @else
          ...
          <td>
            ...
            <form method="POST" action="{{ route('sub.featured.quick.update',$cat->id) }}">
              ...
              <button @if(env('DEMO_LOCK')==0) type="submit" @else disabled title="This operation is disabled in demo !"
                @endif class="btn btn-xs {{ $cat->featured ==1 ? 'btn-success' : 'btn-danger' }}">
              ...
              <li class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-right">
                  ...
                  <li role="presentation"><a role="menuitem" tabindex="-1"
                      href="{{url('admin/subcategory/'.$cat->id.'/edit')}} "><i class="fa fa-pencil-square-o"
                        aria-hidden="true"></i>Edit Subcategory</a></li>
                  @endcan
...
<script>
  var url = {
    !!json_encode(url('/reposition/subcategory/')) !!
  };
</script>
