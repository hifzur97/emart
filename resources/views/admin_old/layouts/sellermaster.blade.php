...
<body class="hold-transition fixed skin-blue sidebar-mini pace-done">
  ...
  <div class="wrapper">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="{{ Nav::isResource('store') }}"><a href="{{route('store.index')}} "><i class="fa fa-address-card-o"
                aria-hidden="true"></i>
              <span>
                {{__("Your Store") }}</span> </a></li>


          <li class="treeview {{ Nav::isRoute("trash.variant.products") }} {{ Nav::isRoute("trash.simple.products") }} {{ Nav::isResource('simple-products') }} {{ Nav::isRoute('seller.get.categories') }} {{ Nav::isRoute('seller.get.subcategories') }} {{ Nav::isRoute('seller.get.childcategories') }} {{ Nav::isRoute('seller.brand.index')  }} {{ Nav::isRoute('seller.pro.vars.all')  }}  {{ Nav::isResource('seller/products') }} {{ Nav::isRoute('seller.import.product') }} {{ Nav::isRoute('seller.add.var') }} {{ Nav::isRoute('seller.manage.stock') }} {{ Nav::isRoute('seller.edit.var') }} {{ Nav::isRoute('seller.pro.vars.all') }} {{ Nav::isRoute('seller.product.attr') }}">
            <a href="#">
              <i class="fa fa-shopping-basket" aria-hidden="true"></i> <span>{{ __("Products Management") }}</span>
              <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
            </a>
            <ul class="treeview-menu">
              <li class="{{ Nav::isRoute('seller.brand.index')  }}"><a href="{{ route('seller.brand.index') }}"><i class="fa fa-circle-o"></i>{{ __("Brands") }}</a></li>
              <li class="{{ Nav::isRoute("trash.variant.products") }} {{ Nav::isRoute('seller.pro.vars.all')  }} {{ Nav::isResource('seller/products') }}"><a
                  href="{{route('my.products.index')}} "><i class="fa fa-circle-o"></i><span>Variant Products</span></a></li>

                  <li class="{{ Nav::isRoute("trash.simple.products") }} {{ Nav::isResource('simple-products') }}">
                    <a href="{{ route('simple-products.index') }} "> <i class="fa fa-circle-o"></i>{{__("Simple Products")}}</a></li>

              <li class="treeview {{ Nav::isRoute('seller.get.categories') }} {{ Nav::isRoute('seller.get.subcategories') }} {{ Nav::isRoute('seller.get.childcategories') }}">
                <a href="#"><i class="fa fa-circle-o"></i>{{__('Categories')}}
                  <span class="pull-right-container">
                    <i class="fa fa-angle-left pull-right"></i>
                  </span>
                </a>
                <ul class="treeview-menu">
                  <li class="{{ Nav::isRoute('seller.get.categories') }}"><a
                      href="{{route('seller.get.categories')}}"><i class="fa fa-circle-o"></i>{{__('Categories')}}</a></li>
                  <li class="{{ Nav::isRoute('seller.get.subcategories') }}"><a
                      href="{{route('seller.get.subcategories')}}"><i class="fa fa-circle-o"></i>{{ __("Subcategories") }}</a></li>
                  <li class="{{ Nav::isRoute('seller.get.childcategories') }}"><a
                      href="{{route('seller.get.childcategories')}}"><i class="fa fa-circle-o"></i>{{ __("Childcategories") }}</a>
                  </li>
                </ul>
              </li>

              <li class="{{ Nav::isRoute('seller.product.attr') }}"><a href="{{route('seller.product.attr')}} "><i
                    class="fa fa-circle-o"></i><span>{{ __("Product Attributes") }}</span></a></li>
              ...
              @if(getPlanStatus() == 1 && auth()->user()->activeSubscription->plan->csv_product == 1)
                <li class="{{ Nav::isRoute('seller.import.product') }}">
                  <a href="{{route('seller.import.product')}} "><i class="fa fa-circle-o"></i><span>{{ __("Import Products") }}</span></a>
                </li>
              @endif
              @else 
              <li class="{{ Nav::isRoute('seller.import.product') }}">
          ...
          <li class="treeview {{ Nav::isResource('order') }} {{ Nav::isRoute('seller.canceled.orders') }}">
            ...
            <a href="#">
              <i class="fa fa-cart-plus" aria-hidden="true"></i><span>{{ __("Order Management") }}</span>
              <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
            </a>
          ...
          <li
            ...
            <ul class="treeview-menu">
              <li class="{{ Nav::isRoute('vender.payout.show.complete') }} {{ Nav::isRoute('seller.payout.index') }}"><a
                  href="{{route('seller.payout.index')}} "><i class="fa fa-circle-o"></i> {{ __("Payouts") }}</a></li>
              <li class="{{ Nav::isRoute('seller.commission') }}"><a href="{{ route('seller.commission') }}"><i
                    class="fa fa-circle-o"></i>{{ __("Commissions") }}</a></li>
    ...
    <footer class="main-footer">
      ...
      <span class="pull-right"><b>{{ __("v") }} {{ config('app.version') }}</b></span>
    </footer>
