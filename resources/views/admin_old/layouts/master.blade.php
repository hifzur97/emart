...
<head>
  ...
  <link type="text/css" rel="stylesheet" href="{{url('admin_lt/vendor/dist/css/adminboot3.css')}}">

  <!-- Bootstrap Tour -->
  <link type="text/css" rel="stylesheet" href="{{url('css/vendor/bootstrap-tour.min.css')}}">
  <!-- Colorpicker -->
  <link type="text/css" rel="stylesheet" href="{{url('admin_lt/vendor/bootstrap-colorpicker/dist/css/bootstrap-colorpicker.min.css')}}">
  <!-- Fontawesome -->
  ...
  <!-- Ionicons -->
  <link type="text/css" rel="stylesheet" href="{{url('admin_lt/vendor/Ionicons/css/ionicons.min.css')}}">
  <link type="text/css" rel="stylesheet" href="{{ url('admin_lt/vendor/icon-font/icon-font.min.css') }}">
  <!-- DataTables -->
  <link type="text/css" rel="stylesheet"
    href="{{url('admin_lt/vendor/datatables.net-bs/css/dataTables.bootstrap.min.css')}}">
  <!-- Select Stylesheets -->
  ...
  @else
  <link type="text/css" rel="stylesheet" href="{{url('admin_lt/css/rtl/bootstrap-rtl.min.css')}}">
  <link type="text/css" rel="stylesheet" href="{{url('admin_lt/css/rtl/adminlte.min.css')}}">
  ...
  <link rel="stylesheet" href="{{ url('admin_lt/css/style.css') }}">
  @if(isset($selected_language) && $selected_language->rtl_available == 1)
  <link type="text/css" rel="stylesheet" href="{{url('admin_lt/css/rtl/profile.css')}}">
  <link type="text/css" rel="stylesheet" href="{{url('admin_lt/css/rtl/rtl.css')}}">
  @endif
  <!-- TinyMCE Editor -->
...
<body class="hold-transition fixed skin-blue sidebar-mini pace-done">
  ...
  <!-- Bootstrap Tour-->
  <script src="{{ url('admin_lt/vendor/dist/js/bootstrap-tour.min.js') }}"></script>
  <!-- jquery UI js -->
