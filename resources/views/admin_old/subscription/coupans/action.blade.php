<a title="Edit Voucher" @if(env('DEMO_LOCK')==0) href="{{ route('subscription-vouchers.edit',$id) }}" @else
  disabled="disabled" title="This operation is disabled in Demo !" @endif class="btn btn-sm btn-success">
