      ...
      <div class="nav-tabs-custom">
        <div class="col-md-2">
            <ul class="nav nav-stacked" role="tablist" id="myTab">
              ...
              <li role="presentation">
                <a href="#cashback_settings" aria-controls="cashback_settings" role="tab" data-toggle="tab"><i class="fa fa-money" aria-hidden="true"></i> {{__("Cashback settings")}}
              </a></li>
        ...
        <div class="col-md-10">
          <div class="tab-content">
            ...
            <div role="tabpanel" class="fade tab-pane" id="cashback_settings">
