		...
		<div class="box-body">
			...
			<div class="nav-tabs-custom">
				<ul class="nav nav-tabs" role="tablist" id="myTab">
					<li role="presentation" class="active"><a href="#variantimport" aria-controls="home" role="tab" data-toggle="tab">{{ __("Import variant products") }}</a></li>
					
					<li role="presentation"><a href="#simpleimport" aria-controls="messages" role="tab" data-toggle="tab">{{ __("Import simple products") }}</a></li>
				</ul>

				<div class="tab-content">
					<div role="tabpanel" class="tab-pane active" id="variantimport">
								...
								<table class="table table-striped">
									...
									<tbody>
										...
										<tr>
											...
											<td>If you set return available = 1, than enter return policy od (must created before entering id here).
					...
					<div role="tabpanel" class="tab-pane fade in" id="simpleimport">
						<a href="{{ url('/files/SimpleProductsCSV.xlsx') }}" class="btn btn-md btn-success">
						...
						<form action="{{ route('import') }}" method="POST" enctype="multipart/form-data">
							...
							<div class="row">
								<div class="form-group col-md-6">
									...
									@endif
									<p></p>
									<button type="submit" class="btn btn-md bg-green">
										{{ __("Import") }}
									</button>
								</div>
								...
								<table class="table table-striped">
									...
									<tbody>
										...
										<tr>
											...
											<td>thumbnail</td>
											<td>Yes</td>
											<td>Name your thumbnail image eg: thumbnail.jpg <b>(Image must be already put in public/images/simple_products) folder )</b> .</td>
										</tr>
										...
										<tr>
											...
											<td>Yes</td>
											<td>Name your hover thumbnail image eg: hover_thumbnail.jpg <b>(Image must be already put in public/images/simple_products) folder )</b> .</td>
										</tr>
										...
										<tr>
											...
											<td>return_policy</td>
											<td>Required if</td>
											<td>If you set return_avbl = 1, than enter return policy id (must created before entering id here).
											You can find return policies ids from here <a target="__blank" href="{{ url("/admin/return-policy") }}">
												Click to view
											</a>
											</td>
