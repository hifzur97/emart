...
<form id="demo-form2" method="post" enctype="multipart/form-data" @if(!empty($products))
  ...
  <div class="row">
    ...
    <div class="col-md-4 margin-top-15">
      ...
      <input type="color" value="{{ $products->sale_tag_text_color }}" class="form-control" name="sale_tag_text_color" placeholder="#000000">
    </div>
    ...
    <div class="col-md-4 margin-top-15">
        ...
        <input type="color" value="{{ $products->sale_tag_color }}" class="form-control" name="sale_tag_color" placeholder="#000000">
    </div>
