   ...
   <div class="box">
      ...
      <div class="box-header">
        ...
        <div class="form-inline pull-right">
          <a title="Import products" href="{{ route('import.page') }}" class="btn btn-md bg-olive"> {{__("Import Products")}} </a>
          <a href="{{ url('admin/products/create') }}" class="btn btn-md btn-success"> <i class="fa fa-plus"></i> {{__("Add Product")}} </a>
          <a href="{{ route('trash.variant.products') }}" class="btn btn-md btn-danger"> <i class="fa fa-trash"></i> {{ __("Trash") }}</a>
        </div>
