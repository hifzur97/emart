          ...
          <form id="demo-form2" method="post" enctype="multipart/form-data" action="{{url('admin/stores/'.$store->id)}}"
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                ...
                <label class="control-label" for="first-name">
                  {{ __('admin.storeOwner') }}: <span class="required">*</span>
                </label>
  
                <select data-placeholder="{{ __('admin.chooseStoreOwner') }}" required name="user_id" class="form-control select2">
              ...
              <div class="last_btn col-md-4">
                ...
                <input placeholder="Please enter your GSTIN/VAT No." type="text" name="vat_no" class="form-control"
                  ...
                  <small class="text-muted">
                    <i class="fa fa-question-circle"></i> {{ __('admin.gstvatno') }}
                  </small>
              </div>
              ...
              <div class="col-md-4 last_btn">
                <label class="control-label" for="first-name">
                  {{ __('admin.Country') }}: <span class="required">*</span>
                </label>
              ...
              <div class="col-md-4 last_btn">
                <label class="control-label" for="first-name">
                  {{ __('admin.State')}}: <span class="required">*</span>
                </label>
              ...
              <div class="col-md-4 last_btn">
                <label class="control-label" for="first-name">
                  {{ __('admin.City')}}: <span class="required">*</span>
                </label>
              ...
              <div class="last_btn col-md-4">
                ...
                <input pattern="[0-9]+" title="Invalid pincode/zipcode" placeholder="{{ __('admin.enterpincode') }}" type="text"
              ...
              <div class="last_btn col-md-4">
                <label class="control-label" for="first-name">
                  {{ __('admin.choosePayout') }}:
                </label>
                <select data-placeholder="{{ __('admin.preferPayout') }}" required name="preferd" id="preferd" class="form-control select2">
              ...
              <div class="last_btn col-md-4">
                  <label> {{__('admin.paypalemail')}} :</label>
              ...
              <div class="last_btn col-md-4">
                  <label> {{__("admin.PaytmMobileNo")}} : ({{ __('admin.IndiaApplicable') }})</label>
