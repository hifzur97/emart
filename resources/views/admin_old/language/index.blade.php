...
@section("body")
	<div class="box">
		<div class="box-header with-border">
			...
			<a title="Click to add new language" data-toggle="modal" data-target="#addLang" class="btn btn-success btn-md pull-right">
				+ Add New Language
			</a>

       <form method="POST" class="margin-right-8 pull-right " action="{{ url('/vue/sync-translation') }}">
         @csrf
        <button title="Sync VUE based homepage translation" type="submit" class="btn btn-success btn-md">
          ...
          <tbody>
            @foreach($allLang as $key=> $lang)
              <tr>
                ...
                <td>
                  <a href="{{ url('languages/'.$lang->lang_code.'/translations') }}" title="Edit Static Words For Language {{ $lang->name }}" class="btn btn-sm btn-flat btn-primary">
                      <i class="fa fa-pencil"></i>
                  </a>
                </td>
              </tr>
        ...
        <form action="{{ route('site.lang.update',$lang->id) }}" method="POST">
        	@csrf
         	...
         	<div class="form-group">
         		...
         		<input required name="name" value="{{ $lang->name }}" type="text" class="form-control" placeholder="enter language name"/>
         	</div>

         	<div class="form-group">
         		<label>Edit Language Code: <span class="required">*</span></label>
         		<input required value="{{ $lang->lang_code }}" type="text" name="lang_code" class="form-control" placeholder="enter language code"/>
         	</div>
