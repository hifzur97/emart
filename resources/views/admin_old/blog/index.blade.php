        ...
        <tr>
          ...
          <td>
            ...
            <form action="{{ route('blog.quick.update',$slider->id) }}" method="POST">
              ...
              <button @if(env('DEMO_LOCK')==0) type="submit" @else disabled title="This operation is disabled in demo !"
                @endif class="btn btn-xs {{ $slider->status==1 ? "btn-success" : "btn-danger" }}">
          ...
          <td>
            ...
            @can('blog.edit')
              ...
              <a href=" {{url('admin/blog/'.$slider->id.'/edit')}} " class="btn btn-sm btn-info"><i
            ...
            @can('blog.delete')
              ...
              <a @if(env('DEMO_LOCK')==0) data-toggle="modal" data-target="#{{$slider->id}}blog" @else disabled
                title="This operation is disabled in demo !" @endif class="btn btn-sm btn-danger">
