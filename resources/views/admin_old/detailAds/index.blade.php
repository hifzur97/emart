...
<div class="box">
  <div class="box-header with-border">
    ...
    <a href=" {{url('admin/detailadvertise/create')}} " class="pull-right btn btn-success owtbtn">+ Add New Block Detail
      Advertise</a>
    @endcan
  </div>
          ...
          <td>
            ...
            <form action="{{ route('detail_button.quick.update',$detail->id) }}" method="POST">
              ...
              <button @if(env('DEMO_LOCK')==0) type="submit" @else disabled="disabled"
                ...
                class="btn btn-xs {{ $detail->status==1 ? "btn-success" : "btn-danger" }}">
