...
<div class="box">
  ...
  <div class="panel-heading">
    <a href=" {{ url('admin/return-policy') }} " class="btn btn-success pull-right owtbtn">
      < Back</a> </div> <!-- /.box-header -->
        <!-- form start -->
        <form id="demo-form2" method="post" enctype="multipart/form-data" action="{{url('admin/return-policy')}}"
