      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            @endcan
            @can('coupans.delete')
            <a title="Delete coupon" @if(env('DEMO_LOCK')==0) data-toggle="modal" data-target="#coupon{{ $cpn->id }}"
              @else title="This operation is disabled in demo !" disabled @endif class="btn btn-sm bg-red btn-flat">
