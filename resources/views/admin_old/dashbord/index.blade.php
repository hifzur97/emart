...
@section('stylesheet')
<link rel="stylesheet" href="{{url('admin_lt/plugins/jvectormap/jquery-jvectormap-1.2.2.css')}}">
@endsection
@section('title','Admin Dashboard |')
@section("body")
              ...
              @foreach($products as $pro)
                ...
                <li class="item">
                  ...
                  <div class="product-info">
                    <a href="{{ $pro['producturl'] }}" class="product-title">{{ $pro['productname'] }}
...
<div class="info-box">
  ...
  <div class="info-box-content">
    <span class="info-box-text">{{ $day }} ! {{ auth()->user()->name }}</span>
...
<!-- jvectormap -->
<script src="{{ url('admin_lt/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js') }}"></script>
<script src="{{ url('admin_lt/plugins/jvectormap/jquery-jvectormap-world-mill-en.js') }}"></script>
<script>
  $(function () {
