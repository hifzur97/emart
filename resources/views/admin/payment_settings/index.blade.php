			...
			<div class="card m-b-30">
				...
				<div class="card-body">
                        ...
                        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                            <a class="nav-link active" id="v-pills-paypal-tab" data-toggle="pill" href="#v-pills-paypal" role="tab" aria-controls="v-pills-paypal" aria-selected="true"><i class="fa fa-cc-paypal" aria-hidden="true"></i> Paypal Payment Settings</a>
                                            <a class="nav-link" id="v-pills-braintree-tab" data-toggle="pill" href="#v-pills-braintree" role="tab" aria-controls="v-pills-braintree" aria-selected="false"><i class="fa fa-cc-discover" aria-hidden="true"></i> Braintree Payment Settings</a>
                                            <a class="nav-link" id="v-pills-stripe-tab" data-toggle="pill" href="#v-pills-stripe" role="tab" aria-controls="v-pills-stripe" aria-selected="false"><i class="fa fa-cc-stripe" aria-hidden="true"></i> Stripe Payment Settings</a>
                                            <a class="nav-link" id="v-pills-paystack-tab" data-toggle="pill" href="#v-pills-paystack" role="tab" aria-controls="v-pills-paystack" aria-selected="false"><i class="fa fa-product-hunt" aria-hidden="true"></i> Paystack Payment Settings</a>
                                            <a class="nav-link" id="v-pills-payubiz-tab" data-toggle="pill" href="#v-pills-payubiz" role="tab" aria-controls="v-pills-payubiz" aria-selected="false"><i class="fa fa-pied-piper-pp" aria-hidden="true"></i> PayuBiz/PayUMoney Payment Settings</a>
                                            <a class="nav-link" id="v-pills-instamojo-tab" data-toggle="pill" href="#v-pills-instamojo" role="tab" aria-controls="v-pills-instamojo" aria-selected="false"><i class="fa fa-italic" aria-hidden="true"></i> Instamojo Payment Settings</a>
                                            <a class="nav-link" id="v-pills-paytm-tab" data-toggle="pill" href="#v-pills-paytm" role="tab" aria-controls="v-pills-paytm" aria-selected="false"><i class="fa fa-credit-card-alt" aria-hidden="true"></i> Paytm Payment Settings</a>
                                            <a class="nav-link" id="v-pills-razorpay-tab" data-toggle="pill" href="#v-pills-razorpay" role="tab" aria-controls="v-pills-razorpay" aria-selected="false"><i class="fa fa-connectdevelop" aria-hidden="true"></i> Razorpay Payment Settings</a>
                                            <a class="nav-link" id="v-pills-payhere-tab" data-toggle="pill" href="#v-pills-payhere" role="tab" aria-controls="v-pills-payhere" aria-selected="false"><i class="fa fa-paper-plane-o" aria-hidden="true"></i> PayHere Payment Settings</a>
                                            <a class="nav-link" id="v-pills-cashfree-tab" data-toggle="pill" href="#v-pills-cashfree" role="tab" aria-controls="v-pills-cashfree" aria-selected="false"><i class="fa fa-circle-o" aria-hidden="true"></i> Cashfree Payment Settings</a>
                                            <a class="nav-link" id="v-pills-skrill-tab" data-toggle="pill" href="#v-pills-skrill" role="tab" aria-controls="v-pills-skrill" aria-selected="false"> <i class="fa fa-circle-o" aria-hidden="true"></i> Skrill Payment Settings</a>
                                            <a class="nav-link" id="v-pills-omise-tab" data-toggle="pill" href="#v-pills-omise" role="tab" aria-controls="v-pills-omise" aria-selected="false"> <i class="fa fa-circle-o" aria-hidden="true"></i> Omise Payment Settings</a>
                                            <a class="nav-link" id="v-pills-moli-tab" data-toggle="pill" href="#v-pills-moli" role="tab" aria-controls="v-pills-moli" aria-selected="false"> <i class="fa fa-circle-o" aria-hidden="true"></i> Moli Payment Settings</a>
                                            <a class="nav-link" id="v-pills-rave-tab" data-toggle="pill" href="#v-pills-rave" role="tab" aria-controls="v-pills-rave" aria-selected="false"> <i class="fa fa-circle-o" aria-hidden="true"></i> Rave Payment Settings</a>
                                            <a class="nav-link" id="v-pills-sslcommerze-tab" data-toggle="pill" href="#v-pills-sslcommerze" role="tab" aria-controls="v-pills-sslcommerze" aria-selected="false"> <i class="fa fa-circle-o" aria-hidden="true"></i> SSLCommerze Payment Settings</a>
                                            <a class="nav-link" id="v-pills-aamarpay-tab" data-toggle="pill" href="#v-pills-aamarpay" role="tab" aria-controls="v-pills-aamarpay" aria-selected="false"> <i class="fa fa-circle-o" aria-hidden="true"></i> AAMARPAY Payment Settings</a>
                                            <a class="nav-link" id="v-pills-iyzico-tab" data-toggle="pill" href="#v-pills-iyzico" role="tab" aria-controls="v-pills-iyzico" aria-selected="false"> <i class="fa fa-circle-o" aria-hidden="true"></i> iyzico Payment Settings</a>
                                            ...
                                            @endif
                                            <a class="nav-link" id="v-pills-bank-tab" data-toggle="pill" href="#v-pills-bank" role="tab" aria-controls="v-pills-bank" aria-selected="false"> <i class="fa fa-circle-o" aria-hidden="true"></i> Bank Transfer Payment Settings</a>
                                        </div>
						</div>
					</div>
				</div>
					...
					<div class="card-body">
						...
						<div class="row">
                            ...
                            <div class="tab-content" id="v-pills-tabContent">
                                                   ...
                                                   <div class="panel panel-primary">
                                                       ...
                                                       <div class="panel-body">
                                                           <div id="pkey"
                                                               ...
                                                               <label class="text-dark" for="PAYPAL_CLIENT_ID">PAYPAL CLIENT ID :</label>
                                                           ...
                                                           <div id="psec"
                                                               ...
                                                               <label class="text-dark" for="PAYPAL_SECRET">PAYPAL SECRET ID :</label>
                                                               <!-- --------------- -->
                                                               <input id="paypl_secret" id="pps" type="password" placeholder="enter secret key" class="form-control"  name="PAYPAL_SECRET" value="{{ env('PAYPAL_SECRET') }}" >
                                                           ...
                                                           <div id="pmode"
                                                               class="form-group {{ $configs->paypal_enable==0 ? 'display-none' : ""}}">
                                                               <label class="text-dark" for="MAIL_ENCRYPTION">PAYPAL MODE :</label>
                                                           ...
                                                           <label class="switch">
                                                             <input class="slider" type="checkbox" name="paypal_check" {{ $configs->paypal_enable==1 ? "checked" : "" }} />
                                                       ...
                                                       <button type="reset" class="btn btn-danger mr-1"><i class="fa fa-ban"></i> {{ __("Reset")}}</button>
                                                           <button @if(env('DEMO_LOCK')==0) type="submit" @else disabled title="This action is disabled in demo !" @endif type="submit" class="btn btn-md btn-primary">
                                               ...
                                               <form action="{{ route('bt.setting.update') }}" method="POST">
                                                     ...
                                                     <div class="panel panel-primary">
                                                         <div class="panel-heading">
                                                             ...
                                                             <div class="pull-right panel-title"><a target="__blank" title="Get Your Keys From here" href="https://developers.braintreepayments.com/"><i class="fa fa-key" aria-hidden="true"></i> Get Your Keys From here</a></div>
                                                         </div>

                                                         <div class="panel-body">

                                                             <div class="form-group">
                                                                 <label class="text-dark" for="BRAINTREE_ENV">BRAINTREE ENVIRONMENT :</label>
                                                             ...
                                                             <div class="form-group">
                                                                 <label class="text-dark" for="BRAINTREE_MERCHANT_ID">BRAINTREE MERCHANT ID :</label>
                                                             ...
                                                             <div class="form-group">
                                                                 <label class="text-dark" for="BRAINTREE_MERCHANT_ID">BRAINTREE MERCHANT ACCOUNT ID :</label>
                                                                 <input type="text" name="BRAINTREE_MERCHANT_ACCOUNT_ID" value="{{  env('BRAINTREE_MERCHANT_ACCOUNT_ID') }}" class="form-control">
                                                                 <small class="text-muted"><i class="fa fa-question-circle"></i> Enter your<a target="__blank" href="https://articles.braintreepayments.com/control-panel/important-gateway-credentials#merchant-account-id-versus-merchant-id">BRAINTREE MERCHANT ACCOUNT ID</a> Key</small>
                                                             </div>

                                                             <div class="form-group eyeCy">
                                                                 <label class="text-dark" for="BRAINTREE_PUBLIC_KEY">BRAINTREE PUBLIC KEY :</label>
                                                                   <!-- --------------- -->
                                                                   <input id="pass_log_id21" type="password" class="form-control"  name="BRAINTREE_PUBLIC_KEY" value="{{ env('BRAINTREE_PUBLIC_KEY') }}" >
                                                                   <span toggle="#password-field" class="fa fa-fw fa-eye field_icon toggle-password21"></span>
                                                                   <!-- --------------- -->
                                                             ...
                                                             <div class="form-group eyeCy">
                                                                 <label class="text-dark" for="BRAINTREE_PRIVATE_KEY">BRAINTREE PRIVATE KEY :</label>
                                                                   <!-- --------------- -->
                                                                   <input id="pass_log_id22" type="password" class="form-control"  name="BRAINTREE_PRIVATE_KEY" value="{{ env('BRAINTREE_PRIVATE_KEY') }}" >
                                                                   <span toggle="#password-field" class="fa fa-fw fa-eye field_icon toggle-password22"></span>
                                                                   <!-- --------------- -->
                                                             ...
                                                             <!-- ------------ -->
                                                             <label class="switch">
                                                               <input class="slider" type="checkbox" id="braintree_enable" name="braintree_enable" {{ $configs->braintree_enable==1 ? "checked" :"" }} />
                                                               <span class="knob"></span>
                                                             </label><br>
                                                             <!-- ------------ -->
                                                     ...
                                                     <div class="panel panel-primary">
                                                         ...
                                                         <div class="panel-body">
                                                             ...
                                                             <div id="skey"
                                                                 ...
                                                                 <label class="text-dark" for="MAIL_FROM_NAME">STRIPE KEY :</label>
                                                             ...
                                                             <div id="sst"
                                                                 ...
                                                                 <label class="text-dark" for="MAIL_FROM_ADDRESS">STRIPE SECRET :</label>
                                                                   <!-- --------------- -->
                                                                   <input id="pass_log_id31" type="password" class="form-control"  name="STRIPE_SECRET" value="{{ env('STRIPE_SECRET') }}" >
                                                                   <span toggle="#password-field" class="fa fa-fw fa-eye field_icon toggle-password31"></span>
                                                                   <!-- --------------- -->
                                                              ...
                                                              <label class="switch">
                                                               <input class="slider" type="checkbox" id="toggle1" name="strip_check" {{ $configs->stripe_enable==1 ? "checked" :"" }} />
                                                               <span class="knob"></span>
                                                             </label><br>
                                                   ...
                                                   <form action="{{ route('store.paystackupdate.settings') }}" method="POST">
                                                       ...
                                                       <div class="panel panel-primary">
                                                           <div class="panel-heading">
                                                               ...
                                                               <div class="pull-right panel-title"><a target="__blank" title="Get Your Keys From here" href="https://paystack.com/developers"><i class="fa fa-key" aria-hidden="true"></i> Get Your Keys From here</a></div>
                                                           </div>

                                                           <div class="panel-body">
                                                               <div class="form-group eyeCy">
                                                                   <label class="text-dark" for="PAYSTACK_PUBLIC_KEY">PAYSTACK PUBLIC KEY :</label>
                                                                    <!-- --------------- -->
                                                                    <input id="pass_log_id41" type="password" class="form-control"  name="PAYSTACK_PUBLIC_KEY" value="{{ env('PAYSTACK_PUBLIC_KEY') }}" >
                                                                   <span toggle="#password-field" class="fa fa-fw fa-eye field_icon toggle-password41"></span>
                                                                   <!-- --------------- -->
                                                               ...
                                                               <div class="form-group eyeCy">
                                                                   <label class="text-dark" for="PAYSTACK_SECRET_KEY">PAYSTACK SECRET KEY :</label>
                                                                   <!-- --------------- -->
                                                                   <input id="pass_log_id42" type="password" class="form-control"  name="PAYSTACK_SECRET_KEY" value="{{ env('PAYSTACK_SECRET_KEY') }}" >
                                                                   <span toggle="#password-field" class="fa fa-fw fa-eye field_icon toggle-password42"></span>
                                                                   <!-- --------------- -->
                                                               ...
                                                               <div class="form-group">
                                                                 <label class="switch">
                                                                   <input class="slider" type="checkbox" id="paystack_enable" name="paystack_enable" {{ $configs->paystack_enable == 1 ? "checked" :"" }} />
                                                                   <span class="knob"></span>
                                                                 </label><br>
                                                           ...
                                                           <div class="form-group">
                                                               <button type="reset" class="btn btn-danger mr-1"><i class="fa fa-ban"></i> {{ __("Reset")}}</button>
                                                               <button @if(env('DEMO_LOCK')==0) type="submit" @else disabled title="This action is disabled in demo !" @endif class="btn btn-md btn-primary"><i class="fa fa-check-circle"></i> Save Changes</button>
                                                           </div>
                                           ...
                                           <div class="tab-pane fade" id="v-pills-payubiz" role="tabpanel" aria-labelledby="v-pills-payubiz-tab">
                                               ...
                                               <form action="{{ route('store.payu.settings') }}" method="POST">
                                                     ...
                                                     <div class="panel panel-primary">
                                                         ...
                                                         <div class="panel-heading">
                                                             <label class="text-dark" for="MAIL_FROM_NAME"> PayU Money API Setting (Indian Payment gateway) :</label>
                                                             <div class="pull-right panel-title"><a target="__blank" title="Get Your Keys From here" href="https://developer.payumoney.com/"><i class="fa fa-key" aria-hidden="true"></i> Get Your Keys From here</a>
                                                             </div>
                                                         </div>
                                                         ...
                                                         <div class="panel-body">
                                                             ...
                                                             <div class="row">
                                                                 ...
                                                                 <div class="form-group col-md-6">
                                                                     ...
                                                                     <input value="{{ env('PAYU_DEFAULT') }}" type="text" name="PAYU_DEFAULT" class="form-control" placeholder="PAYU DEFAULT MODE">
                                                                     <small class="text-muted"><i class="fa fa-question-circle"></i> If your account on PayUMoney use <b>money</b> else use<b>biz</b></small>
                                                                 </div>

                                                                 <div class="form-group col-md-6">
                                                                     <label class="text-dark">PayU Method:</label>
                                                                     <input value="{{ env('PAYU_METHOD') }}" type="text" name="PAYU_METHOD" class="form-control" placeholder="PAYU DEFAULT METHOD">
                                                                     <small class="text-muted"><i class="fa fa-question-circle"></i> For Live use <b>secure</b> and for Test use <b>test</b> as mode</small>
                                                                 </div>

                                                                 <div class="form-group col-md-6">
                                                                     <div class="eyeCy">
                                                                         <label class="text-dark" for="PAYU_MERCHANT_KEY"> PayU Merchant Key :</label>
                                                                         <!-- ------------------------ -->
                                                                         <input id="pass_log_id51" class="form-control" type="password" name="PAYU_MERCHANT_KEY" value="{{ env('PAYU_MERCHANT_KEY') }}">
                                                                         <span toggle="#password-field" class="fa fa-fw fa-eye field_icon toggle-password51"></span>
                                                                         <!-- ------------------------ -->
                                                                 ...
                                                                 <div class="form-group col-md-6">
                                                                     <div class="eyeCy">
                                                                         <label class="text-dark" for="PAYU_MERCHANT_SALT"> PayU MERCHANT SALT:</label>
                                                                         <!-- --------------- -->
                                                                         <input id="pass_log_id52" type="password" class="form-control"  name="PAYU_MERCHANT_SALT" value="{{ env('PAYU_MERCHANT_SALT') }}" >
                                                                         <span toggle="#password-field" class="fa fa-fw fa-eye field_icon toggle-password52"></span>
                                                                         <!-- --------------- -->
                                                                         <!-- <input type="password" value="{{ env('PAYU_MERCHANT_SALT') }}" name="PAYU_MERCHANT_SALT" id="PAYU_MERCHANT_SALT" type="password" class="form-control">
                                                                 ...
                                                                 <div class="form-group col-md-12">
                                                                     <label for="PAY_U_MONEY_ACC">Is it a PayUMoney account?</label><br>
                                                                   
                                                                     <label class="switch">
                                                                       <input class="slider" type="checkbox" name="PAY_U_MONEY_ACC" {{ env('PAY_U_MONEY_ACC')== true ? "checked" : "" }} />
                                                                       <span class="knob"></span>
                                                                     </label>
                                                             ...
                                                             <label class="switch">
                                                               <input class="slider" type="checkbox" name="payu_chk" {{ $configs->payu_enable == "1" ? "checked"  :"" }} />
                                                               <span class="knob"></span>
                                                             </label><br>
                                           ...
                                           <!-- ----- instamojo tab start-------- -->
                                           <div class="tab-pane fade" id="v-pills-instamojo" role="tabpanel" aria-labelledby="v-pills-instamojo-tab">
                                             <!-- instamojo form start -->
                                             <form action="{{ route('instamojo.update') }}" method="POST">
                                                   @csrf
                                                   <div class="panel panel-primary">
                                                       <div class="panel-heading">
                                                           <label class="text-dark" for="MAIL_FROM_NAME">Instamojo API Setting:</label>
                                                           <div class="pull-right panel-title"><a target="__blank"
                                                                   title="Get Your Keys From here"
                                                       ...
                                                       <div class="panel-body">
                                                           ...
                                                           <label class="text-dark" for="INSTAMOJO_URL"> Instamojo API URL:</label>
                                                           ...
                                                           <label class="text-dark" for="IM_REFUND_URL"> Instamojo API REFUND URL:</label>
                                                           ...
                                                           <div class="eyeCy">
                                                               <label class="text-dark" for="IM_API_KEY"> Private API Key:</label>
                                                               <!-- --------------- -->
                                                               <input id="pass_log_id61" type="password" class="form-control"  name="IM_API_KEY" value="{{ env('IM_API_KEY') }}" >
                                                               <span toggle="#password-field" class="fa fa-fw fa-eye field_icon toggle-password61"></span>
                                                               <!-- --------------- -->
                                                           ...
                                                           <div class="eyeCy">
                                                               ...
                                                               <!-- --------------- -->
                                                               <input id="pass_log_id62" type="password" class="form-control"  name="IM_AUTH_TOKEN" value="{{ env('IM_AUTH_TOKEN') }}" >
                                                               <span toggle="#password-field" class="fa fa-fw fa-eye field_icon toggle-password62"></span>
                                                               <!-- --------------- -->
                                                           ...
                                                           <!-- -------------------------- -->
                                                           <label class="switch">
                                                               <input class="slider" type="checkbox" name="instam_check" {{ $configs->instamojo_enable== "1" ? "checked" : "" }} />
                                                               <span class="knob"></span>
                                                           </label><br>
                                                           <!-- --------------------------- -->
                                                       ...
                                                       <div class="form-group">
                                                       <button type="reset" class="btn btn-danger mr-1"><i class="fa fa-ban"></i> {{ __("Reset")}}</button>
                                                           <button @if(env('DEMO_LOCK')==0) type="submit" @else disabled title="This action is disabled in demo !" @endif class="btn btn-md btn-primary"><i class="fa fa-check-circle"></i> Save Setting</button>
                                                       </div>
                                           ...
                                           <div class="tab-pane fade" id="v-pills-paytm" role="tabpanel" aria-labelledby="v-pills-paytm-tab">
                                               ...
                                               <div class="panel-heading">
                                                   ...
                                                   <div class="pull-right panel-title"><a target="__blank" title="Get Your Keys From here" href="https://developer.paytm.com/docs/"><i class="fa fa-key" aria-hidden="true"></i> Get Your Keys From here</a>
                                                   </div>
                                               </div>
                                               <div class="panel-body">

                                                   <div class="form-group">
                                                       <label class="text-dark" for="PAYTM_ENVIRONMENT"> PAYTM ENVIRONMENT: <span
                                                   ...
                                                   <div class="form-group">
                                                       <div class="eyeCy">
                                                           <label class="text-dark" for="PAYTM_MERCHANT_ID">PAYTM MERCHANT ID: <span
                                                                   class="text-danger">*</span></label>
                                                           <!-- --------------- -->
                                                           <input id="pass_log_id71" type="password" class="form-control"  name="PAYTM_MERCHANT_ID" value="{{ env('PAYTM_MERCHANT_ID') }}" >
                                                           <span toggle="#password-field" class="fa fa-fw fa-eye field_icon toggle-password71"></span>
                                                           <!-- --------------- -->
                                                   ...
                                                   <div class="form-group">
                                                       <div class="eyeCy">
                                                           <label class="text-dark" for="PAYTM_MERCHANT_KEY">PAYTM MERCHANT KEY: <span
                                                                   class="text-danger">*</span></label>
                                                           <!-- --------------- -->
                                                           <input id="pass_log_id72" type="password" class="form-control"  name="PAYTM_MERCHANT_KEY" value="{{ env('PAYTM_MERCHANT_KEY') }}" >
                                                           <span toggle="#password-field" class="fa fa-fw fa-eye field_icon toggle-password72"></span>
                                                           <!-- --------------- -->
                                                   ...
                                                   <p></p>
                                                   <label class="switch">
                                                       <input class="slider" type="checkbox" name="paytmchk" {{ $configs->paytm_enable == 1 ? "checked" : "" }} />
                                                       <span class="knob"></span>
                                                   </label><br>
                                           ...
                                           <div class="tab-pane fade" id="v-pills-razorpay" role="tabpanel" aria-labelledby="v-pills-razorpay-tab">
                                              ...
                                              <form action="{{ route('post.rpay.setting') }}" method="POST">
                                               ...
                                               <div class="panel-body">
                                                   ...
                                                   <div class="form-group">
                                                       <div class="eyeCy">
                                                           <label class="text-dark" for="RAZOR_PAY_KEY"> RazorPay Key: <span class="text-danger">*</span></label>
                                                           <!-- --------------- -->
                                                           <input id="pass_log_id81" type="password" class="form-control"  name="RAZOR_PAY_KEY" value="{{ env('RAZOR_PAY_KEY') }}" >
                                                           <span toggle="#password-field" class="fa fa-fw fa-eye field_icon toggle-password81"></span>
                                                           <!-- --------------- -->
                                                   ...
                                                   <div class="form-group">
                                                       <div class="eyeCy">
                                                           <label for="RAZOR_PAY_SECRET"> RazorPay Secret Key: <span
                                                                   class="text-danger">*</span></label>
                                                           <!-- --------------- -->
                                                           <input id="pass_log_id82" type="password" class="form-control"  name="RAZOR_PAY_SECRET" value="{{ env('RAZOR_PAY_SECRET') }}" >
                                                           <span toggle="#password-field" class="fa fa-fw fa-eye field_icon toggle-password82"></span>
                                                           <!-- --------------- -->
                                                   ...
                                                   <p></p>
                                                   <label class="switch">
                                                       <input class="slider" type="checkbox" name="rpaycheck"  {{ $configs->razorpay == "1" ? "checked" : "" }} />
                                                       <span class="knob"></span>
                                                   </label><br>
                                               ...
                                               <button type="reset" class="btn btn-danger mr-1"><i class="fa fa-ban"></i> {{ __("Reset")}}</button>
                                                   <button @if(env('DEMO_LOCK')==0) type="submit" @else disabled
                                                       title="This action is disabled in demo !" @endif
                                                       class="btn btn-md btn-primary"><i class="fa fa-check-circle"></i> Save
                                                       Setting</button>
                                               </div>
                                           ...
                                           <div class="tab-pane fade" id="v-pills-payhere" role="tabpanel" aria-labelledby="v-pills-payhere-tab">
                                               ...
                                               <form action="{{ route('payhere.settings.update') }}" method="POST">
                                                   ...
                                                   <div class="panel-body">
                                                       ...
                                                       <div class="form-group">
                                                           <div class="eyeCy">
                                                               <label for="PAYHERE_APP_SECRET"> PAYHERE APP Secret Key: <span
                                                                       class="text-danger">*</span></label>
                                                               <!-- --------------- -->
                                                               <input id="pass_log_id91" type="password" class="form-control"  name="PAYHERE_APP_SECRET" value="{{ env('PAYHERE_APP_SECRET') }}" >
                                                               <span toggle="#password-field" class="fa fa-fw fa-eye field_icon toggle-password91"></span>
                                                               <!-- --------------- -->
                                                       ...
                                                       <label class="switch">
                                                           <input class="slider" type="checkbox" name="PAYHERE_MODE" {{ env('PAYHERE_MODE') == "live" ? "checked" : "" }} />
                                                           <span class="knob"></span>
                                                       </label><br>
                                                       ...
                                                       <label class="switch">
                                                           <input class="slider" type="checkbox" name="payhere_enable" {{ $configs->payhere_enable == "1" ? "checked" : "" }} />
                                                           <span class="knob"></span>
                                                       </label><br>
                                               ...
                                               <div class="panel-body">
                                                   ...
                                                   <div class="form-group eyeCy">
                                                       <label class="text-dark" for="my-input">CASHFREE SECRET KEY: <span
                                                               class="text-danger">*</span></label>
                                                       <!-- --------------- -->
                                                       <input id="pass_log_id101" type="password" class="form-control"  name="CASHFREE_SECRET_KEY" value="{{ env('CASHFREE_SECRET_KEY') }}" >
                                                       <span toggle="#password-field" class="fa fa-fw fa-eye field_icon toggle-password101"></span>
                                                       <!-- --------------- -->
                                                   ...
                                                   <div class="form-group">
                                                       ...
                                                       <label class="switch">
                                                           <input class="slider" type="checkbox" name="cashfree_enable" {{ $configs->cashfree_enable == "1" ? "checked" : "" }} />
                                                           <span class="knob"></span>
                                                       </label><br>
                                           ...
                                           <div class="tab-pane fade" id="v-pills-skrill" role="tabpanel" aria-labelledby="v-pills-skrill-tab">
                                               ...
                                               <div class="panel-body">
                                                   ...
                                                   <div class="form-group eyeCy">
                                                       ...
                                                       <!-- --------------- -->
                                                       <input id="pass_log_id111" type="password" class="form-control"  name="SKRILL_API_PASSWORD" value="{{ env('SKRILL_API_PASSWORD') }}" >
                                                       <span toggle="#password-field" class="fa fa-fw fa-eye field_icon toggle-password111"></span>
                                                       <!-- --------------- -->
                                                   ...
                                                   <div class="form-group">
                                                       ...
                                                       <label class="switch">
                                                           <input class="slider" type="checkbox" id="skrill_enable" name="skrill_enable" {{ $configs->skrill_enable == "1" ? "checked" : "" }} />
                                                           <span class="knob"></span>
                                                       </label><br>
                                               ...
                                               <div class="form-group">
                                               <button type="reset" class="btn btn-danger mr-1"><i class="fa fa-ban"></i> {{ __("Reset")}}</button>
                                                   <button type="submit" class="btn btn-primary btn-md"><i class="fa fa-check-circle"></i> Save Settings
                                                   </button>
                                               </div>
                                               </form>
                                           ...
                                           <div class="tab-pane fade" id="v-pills-omise" role="tabpanel" aria-labelledby="v-pills-omise-tab">
                                               ...
                                               <div class="panel-heading">
                                                   ...
                                                   <div class="pull-right panel-title">
                                                       <a target="__blank" title="Get Your Keys From here" href="https://dashboard.omise.co/signup?locale=en&origin=direct"><i class="fa fa-key" aria-hidden="true"></i> Get Your Keys From here</a>
                                                   </div>
                                               </div>

                                               <form id="demo-form2" method="post" enctype="multipart/form-data" action="{{ route('omise.settings') }}">
                                               @csrf
                                               ...
                                               <div class="panel-body">
                                                   ...
                                                   <div class="form-group eyeCy">
                                                       <label for="my-input">OMISE SECRET KEY: <span
                                                               class="text-danger">*</span></label>
                                                               <!-- --------------- -->
                                                               <input id="pass_log_id121" type="password" class="form-control"  name="OMISE_SECRET_KEY" value="{{ env('OMISE_SECRET_KEY') }}" >
                                                               <span toggle="#password-field" class="fa fa-fw fa-eye field_icon toggle-password121"></span>
                                                               <!-- --------------- -->
                                                   ...
                                                   <div class="form-group">
                                                       <label class="switch">
                                                           <input class="slider" type="checkbox" name="omise_enable" {{ $configs->omise_enable == "1" ? "checked" : "" }} />
                                                           <span class="knob"></span>
                                                       </label><br>
                                               ...
                                               <div class="form-group">
                                               <button type="reset" class="btn btn-danger mr-1"><i class="fa fa-ban"></i> {{ __("Reset")}}</button>
                                                   <button type="submit" class="btn btn-primary btn-md"><i class="fa fa-check-circle"></i> Save Settings</button>
                                               </div>
                                               </form>
                                               <!-- omise form end -->
                                           </div>
                                           ...
                                           <div class="tab-pane fade" id="v-pills-moli" role="tabpanel" aria-labelledby="v-pills-moli-tab">
                                               ...
                                               <div class="pull-right panel-title">
                                                   <a target="__blank" title="Get Your Keys From here" href="https://www.mollie.com/dashboard/signup?lang=en"><i class="fa fa-key" aria-hidden="true"></i> Get Your Keys From here</a>
                                               </div>
                                               ...
                                               <div class="panel-body">
                                                   ...
                                                   <div class="form-group eyeCy">
                                                       <label class="text-dark" for="my-input">MOLLIE KEY: <span class="text-danger">*</span></label>
                                                       <!-- --------------- -->
                                                       <input id="pass_log_id131" type="password" class="form-control"  name="MOLLIE_KEY" value="{{ env('MOLLIE_KEY') }}" >
                                                       <span toggle="#password-field" class="fa fa-fw fa-eye field_icon toggle-password131"></span>
                                                       <!-- --------------- -->
                                                   ...
                                                   <div class="form-group">
                                                       <label class="switch">
                                                           <input class="slider" type="checkbox" name="moli_enable" {{ $configs->moli_enable == "1" ? "checked" : "" }} />
                                                           <span class="knob"></span>
                                                       </label><br>
                                                   ...
                                                   <div class="panel-body">
                                                       ...
                                                       <div class="form-group">
                                                           <label class="text-dark" for="my-input">RAVE PUBLIC KEY: <span
                                                                   class="text-danger">*</span></label>
                                                           <!-- --------------- -->
                                                           <input id="pass_log_id141" type="password" class="form-control"  name="RAVE_SECRET_KEY" value="RAVE_PUBLIC_KEY" placeholder="XXXXXXX" >
                                                           <span toggle="#password-field" class="fa fa-fw fa-eye field_icon toggle-password141"></span>
                                                           <!-- --------------- -->
                                                       ...
                                                       <div class="form-group eyeCy">
                                                           <label class="text-dark" for="my-input">RAVE SECRET KEY: <span
                                                                   class="text-danger">*</span></label>
                                                           <!-- --------------- -->
                                                           <input id="pass_log_id142" type="password" class="form-control"  name="RAVE_SECRET_KEY" value="{{ env('RAVE_SECRET_KEY') }}" >
                                                           <span toggle="#password-field" class="fa fa-fw fa-eye field_icon toggle-password142"></span>
                                                           <!-- --------------- -->
                                                       ...
                                                       <div class="form-group">
                                                           <label class="text-dark" for="my-input">RAVE ENVIRONMENT: <span class="text-danger">*</span></label><br>
                                                           <label class="switch">
                                                               <input class="slider" type="checkbox" name="RAVE_ENVIRONMENT" {{ env('RAVE_ENVIRONMENT') == "live" ? "checked" : "" }} />
                                                               <span class="knob"></span>
                                                           </label>
                                                       ...
                                                       <div class="form-group">
                                                           <label class="text-dark" for="my-input">Status: <span
                                                               ...
                                                               <br>
                                                               <label class="switch">
                                                                   <input class="slider" type="checkbox" name="rave_enable" {{ $configs->rave_enable == "1" ? "checked" : "" }} />
                                                                   <span class="knob"></span>
                                                               </label><br>
                                                           <!-- <input name="rave_enable" id="rave_enable"
                                                               {{ $configs->rave_enable == "1" ? "checked" : "" }} type="checkbox"
                                                               class="tgl tgl-skewed">
                                                           <label class="text-dark" class="tgl-btn" data-tg-off="Deactive" data-tg-on="Active"
                                               ...
                                               <form action="{{ route('sslcommerze.settings.update') }}" method="POST">
                                                   ...
                                                   <div class="form-group">
                                                       <div class="eyeCy">
                                                           ...
                                                           <label class="text-dark" for="STORE_PASSWORD"> Store Password:</label>
                                                           <!-- --------------- -->
                                                           <input id="pass_log_id151" type="password" class="form-control"  name="STORE_PASSWORD" id="STORE_PASSWORD" value="{{ env('STORE_PASSWORD') }}" >
                                                           <span toggle="#password-field" class="fa fa-fw fa-eye field_icon toggle-password151"></span>
                                                           <!-- --------------- -->
                                                   ...
                                                   <div class="form-group">
                                                       ...
                                                       <!-- ---------------------- -->
                                                       <label class="switch">
                                                           <input class="slider" type="checkbox" id="IS_LOCALHOST" name="IS_LOCALHOST" {{ env('IS_LOCALHOST') == true ? "checked"  :"" }} />
                                                           <span class="knob"></span>
                                                       </label><br>
                                                       <!-- ---------------------- -->
                                                   ...
                                                   <div class="form-group">
                                                       ...
                                                       <!-- ---------------------- -->
                                                       <label class="switch">
                                                           <input class="slider" type="checkbox" name="SANDBOX_MODE" {{ env('SANDBOX_MODE') == true ? "checked"  :"" }} />
                                                           <span class="knob"></span>
                                                       </label><br>
                                                       <!-- ---------------------- -->
                                                   ...
                                                   <div class="form-group">
                                                       ...
                                                       <!-- ---------------------- -->
                                                       <label class="switch">
                                                           <input class="slider" type="checkbox" name="sslcommerze_enable" {{ $configs->sslcommerze_enable == 1 ? "checked"  :"" }} />
                                                           <span class="knob"></span>
                                                       </label><br>
                                                       <!-- ---------------------- -->
                                           ...
                                           <!-- aamarpay tab start -->
                                               <div class="tab-pane fade" id="v-pills-aamarpay" role="tabpanel" aria-labelledby="v-pills-aamarpay-tab">
                                                   <!-- aamarpay form start -->
                                                   <div class="panel-heading">
                                                   ...
                                                   <div class="panel-body">
                                                       ...
                                                       <div class="form-group eyeCy">
                                                           <label class="text-dark" for="my-input">AAMARPAY KEY: <span class="text-danger">*</span></label>
                                                           <!-- --------------- -->
                                                           <input id="pass_log_id161" type="password" class="form-control"  name="AAMARPAY_KEY" value="{{ env('AAMARPAY_KEY') }}" >
                                                           <span toggle="#password-field" class="fa fa-fw fa-eye field_icon toggle-password161"></span>
                                                           <!-- --------------- -->
                                                       ...
                                                       <div class="form-group">
                                                           <label class="switch">
                                                               <input class="slider" type="checkbox" id="AAMARPAY_SANDBOX" name="AAMARPAY_SANDBOX" {{ env('AAMARPAY_SANDBOX') == "1" ? "checked" : "" }} />
                                                               <span class="knob"></span>
                                                           </label><br>
                                                       ...
                                                       <div class="form-group">
                                                           <label class="switch">
                                                               <input class="slider" type="checkbox" name="enable_amarpay" {{ $configs->enable_amarpay == "1" ? "checked" : "" }} />
                                                               <span class="knob"></span>
                                                           </label><br>
                                                           ...
                                                           <small class="txt-desc">(Enable to activate AAMARPAY Payment gateway.)</small>
                                                       </div>
                                           ...
                                           <!-- iyzico tab start -->
                                           <div class="tab-pane fade" id="v-pills-iyzico" role="tabpanel" aria-labelledby="v-pills-iyzico-tab">
                                               <!-- iyzico form start -->
                                               <div class="panel-heading">
                                               ...
                                               <form action="{{ route('iyzico.settings.update') }}" method="POST">
                                                   ...
                                                   <div class="form-group">
                                                       <div class="eyeCy">
                                                           ...
                                                           <label class="text-dark" for="IYZIPAY_SECRET_KEY"> IYZIPAY SECRET KEY:</label>
                                                           <!-- --------------- -->
                                                           <input id="pass_log_id171" type="password" class="form-control"  name="IYZIPAY_SECRET_KEY" value="{{ env('IYZIPAY_SECRET_KEY') }}" >
                                                           <span toggle="#password-field" class="fa fa-fw fa-eye field_icon toggle-password171"></span>
                                                       ...
                                                       <small><i class="fa fa-question-circle"></i> Enter IYZIPAY SECRET KEY password</small>
                                                   </div>

                                                   <div class="form-group">
                                                           <label class="text-dark" for="">Status:</label><br>
                                                           <label class="switch">
                                                               <input class="slider" type="checkbox" id="iyzico_enable" name="iyzico_enable" {{ $configs->iyzico_enable == 1 ? "checked"  :"" }} />
                                                               <span class="knob"></span>
                                                           </label><br>
