    ...
    <div class="col-lg-12">
      <div class="card m-b-30">
        <div class="card-header">
          <h5 class="box-title">{{ __('Add') }} {{ __('Faq') }}</h5>
        </div>
        <div class="card-body">
          ...
          <div class="form-group">
            <label class="control-label" for="first-name">
              ...
              <input placeholder="Please enter Question" type="text" id="first-name" name="que" value="{{old('que')}}" class="form-control col-md-12">
