         ...
         <div class="h-100 bg-primary-rgba p-3">
            ...
            <form action="{{ url('/update-quick-setting') }}" method="POST">
                ...
                <div class="p-1 row align-items-center pb-2">
                    ...
                    <div class="col-md-8"><h6 class="mb-0">{{ __("Enable Multiseller") }}</h6></div>
                    <div class="col-md-4 text-right"><input {{ isset($vendor_system) && $vendor_system == 1 ? "checked" : "" }} name="vendor_enable" type="checkbox" class="js-switch-setting-first"/></div>
             ...
             <div class="p-1 row align-items-center pb-2">
                ...
                <div class="col-md-8"><h6 class="mb-0">{{ __("Enable Preloader") }}</h6></div>
                <div class="col-md-4 text-right"><input {{ env('ENABLE_PRELOADER') =='1' ? "checked" : "" }} name="ENABLE_PRELOADER" type="checkbox" class="js-switch-setting-first"/></div>
                
                <div class="col-md-12">
                    <small class="text-muted"><i class="fa fa-question-circle"></i> Enable or disable preloader by toggling it.</small>
                </div>
            ...
            <div class="p-1 row align-items-center pb-2">
                ...
                <div class="col-md-8"><h6 class="mb-0">{{ __("APP DEBUG") }}</h6></div>
                <div class="col-md-4 text-right"><input name="APP_DEBUG" @if(env('DEMO_LOCK') !=1)
                    {{ env('APP_DEBUG') == true ? "checked" : "" }} @endif type="checkbox" class="js-switch-setting-first" /></div>

                <div class="col-md-12">
                    <small class="text-muted"><i class="fa fa-question-circle"></i> Turn it <b>ON</b>. IF you face 500 error.</small>
                </div>
            ...
            <div class="p-1 row align-items-center pb-2">
                ...
                <div class="col-md-8"><h6 class="mb-0">{{ __("Disable Right Click?") }}</h6></div>
                <div class="col-md-4 text-right"><input name="right_click" type="checkbox" class="js-switch-setting-first" {{ $genrals_settings->right_click=='1' ? "checked" : "" }} /></div>

                <div class="col-md-12">
                    <small class="text-muted"><i class="fa fa-question-circle"></i> If enabled than Right click will not work on whole project.</small>
                </div>
            ...
            <div class="p-1 row align-items-center pb-2">
                ...
                <div class="col-md-8"><h6 class="mb-0">{{ __("Disables Inspect Element?") }}</h6></div>
                <div class="col-md-4 text-right"><input type="checkbox" class="js-switch-setting-first" name="inspect" {{ $genrals_settings->inspect == '1' ? "checked" : "" }}/></div>

                <div class="col-md-12">
                    <small class="text-muted"><i class="fa fa-question-circle"></i> <b>CTRL+U OR CTRL+SHIFT+I</b> keys not work on whole project.</small>
                </div>
            ...
            <div class="p-1 row align-items-center pb-2">
                ...
                <div class="col-md-8"><h6 class="mb-0">{{ __("Login to display price") }}</h6></div>
                <div class="col-md-4 text-right"><input type="checkbox" class="js-switch-setting-first" name="login" {{ $genrals_settings->login=='1' ? "checked" : "" }} /></div>

                <div class="col-md-12">
                    <small class="text-muted"><i class="fa fa-question-circle"></i> If enabled only logged in users will able to see product prices.</small>
                </div>
            ...
            <div class="p-1 row align-items-center pb-2">
                ...
                <div class="col-md-8"><h6 class="mb-0">{{ __("Enable email verification on registration?") }}</h6></div>
                <div class="col-md-4 text-right"><input type="checkbox" class="js-switch-setting-first" name="email_verify_enable" {{ $genrals_settings->email_verify_enable == 1 ? "checked" : "" }} /></div>

                <div class="col-md-12">
                    <small class="text-muted"><i class="fa fa-question-circle"></i> If enabled than email will be sent to user when register.</small>
                </div>
            ...
            <div class="p-1 row align-items-center pb-2">
                ...
                <div class="col-md-8"><h6 class="mb-0">{{ __("Enable Cash on delivery?") }}</h6></div>
                <div class="col-md-4 text-right"><input type="checkbox" class="js-switch-setting-first" name="COD_ENABLE" {{ env('COD_ENABLE') == 1 ? "checked" : "" }} /></div>

                <div class="col-md-12">
                    <small class="text-muted"><i class="fa fa-question-circle"></i> If enabled than cash on delivery will enable on payment page.</small>
                </div>
            ...
            <div class="p-1 row align-items-center pb-2">
                ...
                <div class="col-md-8"><h6 class="mb-0">{{ __("Hide sidebar?") }}</h6></div>
                <div class="col-md-4 text-right"><input type="checkbox" class="js-switch-setting-first" name="HIDE_SIDEBAR" {{ env('HIDE_SIDEBAR') =='1' ? "checked" : "" }} /></div>

                <div class="col-md-12">
                    <small class="text-muted"><i class="fa fa-question-circle"></i> By toggling it make the full width front page it.</small>
                </div>
         ...
         <div class="p-3" style="maxheight: 500px;overflow: auto">
             ...
             @foreach(auth()->user()->unreadNotifications->where('n_type','=','order_v') as $notification)
                ...
                <div class="bg-primary-rgba p-3">
                    <a class="font-weight-normal" title="{{ $notification->data['data'] }}" onclick="markread('{{ $notification->id }}')"
                        href="{{ url($notification->url) }}">
                        <img src="{{ url('admin_new/assets/images/ecommerce/product_04.svg') }}" class="img-fluid" width="35" alt="product">
                       #{{ $notification->data['data'] }}
                    </a> 
                    <div class="clearfix"></div>
                    <small class="clearfix float-right"><i class="feather icon-calendar" aria-hidden="true"></i>{{ date('jS M y',strtotime($notification->created_at)) }}</small>
             ...
             @else
                ...
                <h4 class="text-center text-primary"><i class="feather icon-bell-off"></i> {{ __("No Notifications") }}</h4>
