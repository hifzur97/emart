            ...
            <ul class="vertical-menu">
              ...
              <li id="menum" class="{{ Nav::isResource('admin/menu') }}">
                <a href="{{ route('menu.index') }}">
                  <i class="feather icon-sliders" aria-hidden="true"></i> <span>Menu Management</span>
              ...
              <li class="{{ Nav::isResource('admin/commission_setting') }} {{ Nav::isResource('admin/commission') }} {{ Nav::isRoute('review.index') }} {{ Nav::isRoute('r.ap') }} {{ Nav::isResource('admin/return-policy') }} {{ Nav::isResource('brand') }} {{ Nav::isResource('coupan') }} {{ Nav::isResource('category') }} {{ Nav::isResource('subcategory') }} {{ Nav::isResource('grandcategory') }} {{ Nav::isResource('products') }} {{ Nav::isResource('unit') }} {{ Nav::isResource('special') }} {{ Nav::isRoute('attr.index') }} {{ Nav::isRoute('attr.add') }} {{ Nav::isRoute('opt.edit') }} {{ Nav::isRoute('pro.val') }} {{ Nav::isRoute('add.var') }} {{ Nav::isRoute('manage.stock') }} {{ Nav::isRoute('edit.var') }} {{ Nav::isRoute('pro.vars.all') }} {{ Nav::isRoute('import.page') }} {{ Nav::isRoute('requestedbrands.admin') }} ? 'show' : ''">
                ...
                <ul class="vertical-submenu">
                  ...
                  {{ Nav::isResource('grandcategory') }}"">
                    ...
                    <ul class="vertical-submenu">
                      ...
                      <li
                        ...
                        <a href="{{url('admin/category')}}">Categories</a></li>
                      @endcan
                      @can('subcategory.view')
                      <li class="{{ Nav::isResource('subcategory') }}"><a href="{{url('admin/subcategory')}}">Subcategories</a></li>
                      @endcan
                      @can('childcategory.view')
                      <li class="{{ Nav::isResource('grandcategory') }}"><a href="{{url('admin/grandcategory')}}">Childcategories</a></li>
                      @endcan
                    </ul>
                  </li>
                  @can('products.view')
                  <li
                    ...
                    <a href="{{url('admin/products')}} ">Variant Products </a></li>
                  @endcan
                  @can('products.view')
                  <li class="{{ Nav::isResource('simple-products') }}">
                    <a href="{{ route('simple-products.index') }} ">{{__("Simple Products")}}</a></li>
                  @endcan
                  @can('products.import')
                  <li class="{{ Nav::isRoute('import.page') }}"><a href="{{ route('import.page') }}">Import Products</a></li>
                  @endcan

                  @can('attributes.view')
                  <li
                    class="{{ Nav::isRoute('pro.val') }} {{ Nav::isRoute('opt.edit') }} {{ Nav::isRoute('attr.add') }}{{ Nav::isRoute('attr.index') }}">
                    <a href="{{route('attr.index')}} ">Product Attributes</a></li>
                  @endcan
                  @can('coupans.view')
                  <li class="{{ Nav::isResource('coupan') }}"><a href="{{url('admin/coupan')}} ">Coupons</a></li>
                  @endcan
                  @can('returnpolicy.view')
                  <li class="{{ Nav::isResource('admin/return-policy') }}"><a href="{{url('admin/return-policy')}} ">Return Policy Settings</a></li>
                  @endcan
                  @can('units.view')
                  <li class="{{ Nav::isResource('unit') }}"><a href="{{url('admin/unit') }}">Units</a></li>
                  @endcan
                  @can('specialoffer.view')
                  <li class="{{ Nav::isResource('special') }}"><a href="{{ url('admin/special') }}">Special Offers</a></li>
                  @endcan

                  @can('review.view')
                  <li class="{{ Nav::isRoute('review.index') }}"><a href="{{url('admin/review')}}">All Reviews</a></li>

                  <li class="{{ Nav::isRoute('r.ap') }}"><a href="{{url('admin/review_approval')}}">Reviews For Approval</a></li>
                  @endcan

                  @can('commission.manage')

                  @if($cms->type =='c')
                  <li class="{{ Nav::isResource('admin/commission') }}"><a href="{{url('admin/commission')}} ">Commissions</a></li>
                  @endif
                  <li class="{{ Nav::isResource('admin/commission_setting') }}"><a
                      href="{{url('admin/commission_setting')}} ">Commission Setting</a></li>
              ...
              <li id="ordersm"
                class="{{ Nav::isResource('admin.pending.orders') }} {{ Nav::isRoute('admin.can.order') }} {{ Nav::isRoute('return.order.show') }} {{ Nav::isRoute('return.order.detail') }} {{ Nav::isRoute('return.order.index') }} {{ Nav::isResource('order') }} {{ Nav::isResource('invoice') }}">

                <a href="javaScript:void();">
                  <i class="feather icon-shopping-cart" aria-hidden="true"></i> <span>Orders & Invoices</span>
                  <i class="feather icon-chevron-right"></i>
                </a>

                <ul class="vertical-submenu">

                  <li class="{{ Nav::isResource('order') }}"><a href="{{route('order.index')}} ">All Orders</a></li>
                  <li class="{{ Nav::isResource('admin.pending.orders') }}"><a href="{{route('admin.pending.orders')}}"></i>Pending Orders </a></li>
                  <li class="{{ Nav::isRoute('admin.can.order') }}"><a href="{{route('admin.can.order')}}"></i>Canceled Orders </a></li>

                  <li class="{{ Nav::isRoute('return.order.index') }} {{ Nav::isRoute('return.order.show') }} {{ Nav::isRoute('return.order.detail') }}">
                    <a href="{{route('return.order.index')}} ">Returned Orders</a></li>
                  @can('invoicesetting.view')
                  <li class="{{ Nav::isResource('invoice') }}"><a href="{{url('admin/invoice')}}">Invoice Setting</a></li>
                  @endcan

                  @can('invoicesetting.view')
                  <li class="{{ Nav::isRoute('get.invoice.design') }}"><a href="{{route('get.invoice.design')}}">Invoice Design</a></li>
                  @endcan
                </ul>
              </li>
              @endcan
              ...
              <li class="{{ Nav::isResource('offline-orders') }} {{ Nav::isRoute('offline.orders.reports') }}">
                ...
                <ul class="vertical-submenu">
                  ...
                  <li class="{{ Nav::isResource('offline-orders') }}">
                    <a href="{{route('offline-orders.index')}} ">All Orders</a>
                  </li>

                  <li class="{{ Nav::isResource('offline-orders') }}">
                    <a href="{{route('offline-orders.create')}}"></i>Create order</a>
                  </li>

                  <li class="{{ Nav::isRoute('offline.orders.reports') }}">
                    <a href="{{route('offline.orders.reports')}}"></i>Reports</a>
                  </li>
              ...
              <li class="{{ Nav::isResource('flash-sales') }} {{ Nav::isRoute('admin.push.noti.settings') }} {{ Nav::isRoute('offer.get.settings') }} {{ Nav::isResource('testimonial') }} {{ Nav::isResource('adv') }} {{ Nav::isResource('hotdeal') }} {{ Nav::isResource('detailadvertise') }}">
                <a href="javaScript:void();">
                  <i class="feather icon-bar-chart-line-" aria-hidden="true"></i><span>Marketing Tools</span>
                  <i class="feather icon-chevron-right"></i>
                </a>

                <ul class="vertical-submenu">
                  @can('hotdeals.view')
                  <li><a class="{{ Nav::isResource('admin/hotdeal') }}" href="{{url('admin/hotdeal')}}">Hot Deals</a></li>
                  @endcan
                  @can('blockadvertisments.view')
                  <li class="{{ Nav::isResource('admin/detailadvertise') }}"><a href="{{url('admin/detailadvertise')}}">Block Advertisments</a></li>
                  @endcan
                  @can('advertisements.view')
                  <li class="{{ Nav::isResource('admin/adv') }}"><a href="{{url('admin/adv')}}">Advertisements</a></li>
                  @endcan
                  @can('testimonials.view')
                  <li class="{{ Nav::isResource('admin/testimonial') }}"><a href="{{url('admin/testimonial')}} ">Testimonials</a></li>
                  @endcan
                  @can('offerpopup.setting')
                  <li class="{{ Nav::isRoute('offer.get.settings') }}"><a href="{{route('offer.get.settings')}} ">Offer PopUp Settings</a></li>
                  @endcan
                  @can('pushnotification.settings')
                  <li class="{{ Nav::isRoute('admin.push.noti.settings') }}"><a
                      href="{{route('admin.push.noti.settings')}}">Push Notifications</a></li>
                  @endcan

                  @can('hotdeals.view')
                  <li class="{{ Nav::isResource('flash-sales') }}"><a
                    href="{{route('flash-sales.index')}}">Flash sales</a></li>
                  @endcan
              ...
              @can('location.manage')
              <li id="location"
                class="{{ Nav::isRoute('country.list.pincode') }} {{ Nav::isRoute('admin.desti') }} {{ Nav::isRoute('country.index') }} {{ Nav::isRoute('state.index') }} {{ Nav::isRoute('city.index') }}">
                <a href="javaScript:void();">
                ...
                <ul class="vertical-submenu">
                  <li class="{{ Nav::isResource('country') }}"><a href="{{url('admin/country')}}">Countries</a></li>
                  <li class="{{ Nav::isResource('state') }}"><a href="{{url('admin/state')}}">States</a></li>
                  <li class="{{ Nav::isResource('city') }}"><a href="{{url('admin/city')}}">Cities</a></li>
                  <li class="{{ Nav::isRoute('country.list.pincode') }}{{ Nav::isRoute('admin.desti') }}"><a
                      href="{{url('admin/destination')}}">Delivery Locations</a></li>
                </ul>
              ...
              {{ Nav::isResource('tax') }}">
                @can('shipping.manage')
                <a href="javaScript:void();">
                  <i class="feather icon-truck" aria-hidden="true"></i><span>Shipping & Taxes</span>
                  <i class="feather icon-chevron-right"></i>
                </a>
                @endcan
                @can('taxsystem.manage')
                <ul class="vertical-submenu">
                  <li class="{{ Nav::isResource('tax_class')  }}"><a href="{{url('admin/tax_class')}}">Tax Classes</a></li>
                  <li class="{{ Nav::isRoute('tax.index') }}{{ Nav::isRoute('tax.edit') }}{{ Nav::isRoute('tax.create') }}">
                    <a href="{{url('admin/tax')}}">Tax Rates</a></li>
                  <li class="{{ Nav::isResource('admin/zone') }}"><a href="{{url('admin/zone')}}">Zones</a></li>
                  <li class="{{ Nav::isResource('shipping') }}"><a href="{{url('admin/shipping')}}">Shipping</a></li>
                </ul>
                @endcan
              </li>
              @endcan
              ...
              <li
                ...
                <ul class="vertical-submenu">
                  ...
                  <li class="{{ Nav::isRoute('seller.payouts.index') }}"><a href="{{route('seller.payouts.index')}} ">Pending Payouts</a></li>

                  <li class="{{ Nav::isRoute('seller.payout.show.complete') }} {{ Nav::isRoute('seller.payout.complete') }}"><a href="{{ route('seller.payout.complete') }}">Completed Payouts</a></li>
              ...
              <li id="mscur" class="{{ Nav::isResource('admin/multiCurrency') }}"><a
                  href="{{url('admin/multiCurrency')}} "><i class="fa fa-money"></i><span>Currency settings</span></a>
              </li>
              @endcan
              ...
              <li
                class="{{ Nav::isRoute('seller.subs.listofsubs') }} {{ Nav::isResource('subscription-vouchers') }} {{ Nav::isResource('plans') }}">
                <a href="javaScript:void();"><i class="feather icon-credit-card"></i>
                  <span>
              ...
              <li
                ...
                <ul class="vertical-submenu">
                  ...
                  <li id="slider" class="treeview {{ Nav::isRoute('front.slider') }} {{ Nav::isResource('slider') }}">
                    ...
                    <ul class="vertical-submenu">
                      <li class="{{ Nav::isResource('slider') }}"><a href="{{url('admin/slider')}} ">Sliders</a></li>
                      <li class="{{ Nav::isRoute('front.slider') }}">
                        <a href="{{route('front.slider')}} "><span>Top Category Slider</span></a>
                      </li>
                    </ul>
                  </li>
                  @endcan
                  ...
                  <li class="{{ Nav::isRoute('pwa.setting.index') }}"><a title="Progressive Web App Setting"
                      href="{{route('pwa.setting.index')}} "><span>PWA Settings</span></a>
                  </li>
                  @endcan

                  @can('color-options.manage')
                  <li id="theme-settings" class="{{ Nav::isRoute('admin.theme.index') }}">
                    <a href="{{ route('admin.theme.index') }}"><span>Color Options</span>
                    </a>
                  </li>
                  @endcan

                  @can('faq.view')
                  <li id="faqs" class="{{ Nav::isResource('faq') }}"><a href="{{url('admin/faq')}} "><span>FAQ's</span></a>
                  </li>
                  @endcan
                  ...
                  <li class="{{ Nav::isRoute('widget.setting') }}">
                    ...
                    <a href="{{ route('widget.setting') }}"><span>Widgets Settings</span></span></a>
                  ...
                  <li class="{{ Nav::isRoute('payment.gateway.settings') }}">
                    ...
                    <a href="{{ route('payment.gateway.settings') }}"><span>Payment Gateway
                        Settings</span></a>
                  ...
                  <li class="{{ Nav::isRoute('manual.payment.gateway') }}">
                    ...
                    <a href="{{ route('manual.payment.gateway') }}"><span>Offline Payment Gateway</span></a>
                  ...
                  <li class="{{ Nav::isRoute('customstyle') }}">
                    <a href="{{ route('customstyle') }}"><span>Custom Style and JS</span></a>
                  </li>
                  @endcan

                  @can('site-settings.footer-customize')
                  <li class="{{ Nav::isRoute('footer.index') }}"><a href="{{url('admin/footer')}} ">Footer Customizations</a></li>
                  @endcan

                  @can('site-settings.social-handle')
                  <li class="{{ Nav::isResource('social') }}"><a href="{{url('admin/social')}} ">Social Handler Settings</a></li>
                  @endcan

                  @can('blog.view')
                  <li class="{{ Nav::isResource('blog') }}"><a href="{{url('admin/blog')}}">Blogs</a></li>
                  @endcan

                  @can('pages.view')
                  <li class="{{ Nav::isResource('page') }}"><a href="{{url('admin/page')}}">Pages</a>
                  </li>
                  @endcan
              ...
              <li id="sitesetting" {{ Nav::isRoute('get.user.terms') }} {{ Nav::isRoute('sms.settings') }}
                ...
                {{ Nav::isRoute('get.paytm.setting') }} {{ Nav::isResource('page') }} {{ Nav::isRoute('admin.dash') }}
                {{ Nav::isRoute('static.trans')  }}">
                <a href="javaScript:void();">
                ...
                <ul class="vertical-submenu">
                  ...
                  <li class="{{ Nav::isRoute('genral.index') }}"><a href="{{url('admin/genral')}}">General Settings</a></li>
                  @endcan
                  ...
                  <li class="{{ Nav::isRoute('static.trans')  }} {{ Nav::isRoute('site.lang') }}"><a
                      href="{{route('site.lang')}}">Site Languages</a></li>
                  @endcan

                  @can('site-settings.mail-settings')
                  <li class="{{ Nav::isRoute('mail.getset') }}"><a href="{{url('admin/mail-settings')}}">Mail Settings</a></li>
                  @endcan

                  @can('site-settings.social-login-settings')
                  <li class="{{ Nav::isRoute('gen.set') }}"><a href="{{route('gen.set')}}">Social Login Settings</a></li>
                  @endcan

                  @can('site-settings.sms-settings')
                  <li class="{{ Nav::isRoute('sms.settings') }}"><a href="{{route('sms.settings')}}">SMS Settings</a></li>
                  @endcan

                  @can('site-settings.dashboard-settings')
                  <li class="{{ Nav::isRoute('admin.dash') }}">
                    <a href="{{ route('admin.dash') }}"><span>Admin Dashboard Settings</span></a>
                  </li>
                  @endcan

                  @can('site-settings.maintenance-mode')
                  <li class="{{ Nav::isRoute('get.view.m.mode') }}">
                    <a href="{{ route('get.view.m.mode') }}"><span>Maintenance Mode</span></a>
                  </li>
                  @endcan

                  @can('terms-settings.update')
                  <li id="sitesetting" class="{{ Nav::isRoute('get.user.terms') }}">
                    <a href="{{ route('get.user.terms') }}"><span>Terms Pages</span>
                    </a>
                  </li>
                  @endcan

                  @can('site-settings.bank-settings')
                  <li class="{{ Nav::isResource('admin/bank_details') }}"><a href="{{url('admin/bank_details')}} "></i><span>Bank Details</span></a></li>
                  @endcan


                  @can('others.abuse-word-manage')
                  <li class="{{ Nav::isResource('admin/abuse') }}">
                    <a href="{{ url('admin/abuse') }}"><span>Abuse Word Settings</span></a>
                  </li>
                  @endcan
                </ul>
              </li>
              ...
              @can('wallet.manage')
              <li class="{{ Nav::isRoute('admin.wallet.settings') }}"><a href="{{ route('admin.wallet.settings') }}"><i class="feather icon-briefcase" aria-hidden="true"></i><span>Wallet</span></a></li>
              @endcan
              ...
              <li id="ticket" class="{{ Nav::isRoute('tickets.admin') }} {{ Nav::isRoute('ticket.show') }}">
                <a href="{{ route('tickets.admin') }}">
                  <i class="feather icon-volume-1" aria-hidden="true"></i><span>Support Tickets</span></a>
              </li>
              ...
              <li id="reppro" class="{{ Nav::isRoute('get.rep.pro') }}">
                <a href="{{ route('get.rep.pro') }}">
                  <i class="feather icon-alert-circle" aria-hidden="true"></i><span>Reported Products</span></a>
              </li>
              @endcan

              @can('addon-manager.manage')
              <li class="{{ Nav::isRoute('addonmanger.index') }}"><a title="Progressive Web App Setting"
                  href="{{route('addonmanger.index')}} "><i class="feather icon-download"></i><span>{{ __("Add-on Manager") }} <small class="badge badge-success float-right">NEW</small></span>
                </a></li>
              @endcan
              ...
              @can('reports.view')
              <li
                class="{{ Nav::isRoute('admin.report.mostviewed') }} {{ Nav::isRoute('admin.stock.report') }} {{ Nav::isRoute('admin.sales.report') }}">
                <a href="javaScript:void();">
              ...
              <li
                ...
                <a href="javaScript:void();">
                  <i class="feather icon-help-circle" aria-hidden="true"></i><span>Help & Support</span>
                  <i class="feather icon-chevron-right"></i>
                </a>
                <ul class="vertical-submenu">
                  ...
                  <li class="{{ Nav::isRoute('admin.import.demo') }}">
                    <a href="{{ url('/admin/import-demo') }}"><span>Import Demo</span></a>
                  </li>
                  @endcan

                  @can('others.database-backup')
                  <li id="reppro" class="{{ Nav::isRoute('admin.backup.settings') }}">
                    <a href="{{ route('admin.backup.settings') }}"><span>Database Backup</span></a>
                  </li>
                  @endcan

                  @can('others.systemstatus')
                  <li class="{{ Nav::isRoute('systemstatus') }}">
                    <a href="{{ route('systemstatus') }}"><span>System Status</span>
                    </a>
                  </li>
                  @endcan
                  ...
                  <li class="{{ Nav::isRoute('others.settings') }}">
                    <a href="{{ route('others.settings') }}"><span>Remove Public & Force HTTPS</span>
                    </a>
                  </li>
                  @endif
