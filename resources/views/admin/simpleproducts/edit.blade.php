                    ...
                    <ul class="nav custom-tab-line nav-tabs mb-3" id="defaultTab" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="productspecifications-tab" data-toggle="tab"
                                ...
                                aria-selected="false">{{ __("Product Specifications") }}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="image-tab" data-toggle="tab" href="#image" role="tab"
                                aria-controls="image" aria-selected="false">{{ __("360° Image") }}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="productfaq-tab" data-toggle="tab" href="#productfaq" role="tab"
                                aria-controls="productfaq" aria-selected="false">{{ __("Product FAQ's") }}</a>
                        </li>
                    </ul>
                                ...
                                <div class="col-md-9">
                                    ...
                                    <form action="{{ route("simple-products.update",$product->id) }}" method="POST"
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="text-dark">Product Thumbnail Image: </label>
                                                    <!-- --------------------- -->
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <div class="custom-file">
                                                            <input type="file" class="custom-file-input"
                                                                name="thumbnail" id="inputGroupFile01"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="text-dark">Product Hover Thumbnail Image:</label>
                                                    <!-- --------------------- -->
                                                    <div class="input-group mb-3">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text"
                                                        ...
                                                        <div class="custom-file">
                                                            <input type="file" class="custom-file-input"
                                                                name="hover_thumbnail" id="inputGroupFile01"
                                                                aria-describedby="inputGroupFileAddon01">
                                                            <label class="custom-file-label"
                                                                for="inputGroupFile01">Choose file</label>
                                                        </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="text-dark">Product Gallery Images:</label>
                                                    <!-- --------------------- -->
                                                    <div class="input-group mb-3">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text"
                                            ...
                                            <div
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <div class="custom-file">
                                                            <input type="file" class="custom-file-input"
                                                                name="product_file" id="inputGroupFile01"
                                                                aria-describedby="inputGroupFileAddon01">
                                                            <label class="custom-file-label"
                                                                for="inputGroupFile01">Choose file</label>
                                                        </div>
